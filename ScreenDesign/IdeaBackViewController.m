...
-(void)creatUI
{
    ...
    UIImageView *imgView=[[UIImageView alloc]initWithFrame:CGRectMake(AUTO_MATE_WIDTH(10), AUTO_MATE_HEIGHT(10), AUTO_MATE_WIDTH(300), AUTO_MATE_HEIGHT(240))];
