...
-(void)setUpPickView{
    ...
    pickView.backgroundColor=[UIColor colorWithRed:247/255.0 green:247/255.0 blue:247/255.0 alpha:1];
...
//    datePicker.maximumDate;
    ...
    datePicker.backgroundColor=[UIColor colorWithRed:247/255.0 green:247/255.0 blue:247/255.0 alpha:1];
    if (_defaulDate) {
...
-(void)doneClick
{
    if (_pickerView) {
        ...
        _resultString  = [dateFor stringFromDate:_datePicker.date];
        
//        NSString *date=[NSString stringWithFormat:@"%@",_datePicker.date];
//        NSString *str=[date substringToIndex:10];
//        _resultString=[NSString stringWithFormat:@"%@",str];
//        
